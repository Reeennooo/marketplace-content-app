...
// node_modules/figma-squircle/dist/index.js
...
function useEventListener(eventName, handler, element, options) {
  var savedHandler = (0, import_react3.useRef)(handler);
...
function useElementSize(defaultSize) {
  var _useState = _sliced_to_array((0, import_react2.useState)(null), 2), ref = _useState[0], setRef2 = _useState[1];
  var _defaultSize_defaultWidth, _defaultSize_defaultHeight;
  var _useState1 = _sliced_to_array((0, import_react2.useState)({
  ...
  var handleSize = (0, import_react2.useCallback)(function() {
...
var SquircleNoScript = function() {
  return (0, import_jsx_runtime2.jsx)("noscript", {
...
var StaticSquircle = function(_param) {
  ...
  var path = (0, import_react5.useMemo)(function() {
    return getSvgPath({
      width,
      height,
      cornerRadius,
...
function Squircle(_param) {
  ...
  var path = (0, import_react.useMemo)(function() {
  ...
  return (0, import_jsx_runtime4.jsx)(Component, _object_spread_props(_object_spread({}, props), {
    ref,
...
//# sourceMappingURL=@squircle-js_react.js.map
